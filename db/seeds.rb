...
Category.transaction do
  ...
  Product.create!(category: c1, name: 'Sack', description: 'Heavy duty bag. Able to load 20 kgs. Sack - A stuff sack is a type of drawstring bag, usually used for storing camping items. Stuff sacks are commonly used for the storage of sleeping bags, which are otherwise bulky and difficult to manage.', price: 80, available_quantity: 15, image: URI.encode(sack_bag_url))
  Product.create!(category: c1, name: 'Yellow Bag', description: 'Light and eco friendly colors. Bag - A bag (also known regionally as a sack) is a common tool in the form of a non-rigid container. The use of bags predates recorded history, with the earliest bags being no more than lengths of animal skin, cotton, or woven plant fibers, folded up at the edges and secured in that shape with strings of the same material', price: 10, available_quantity: 36, image: URI.encode(yellow_bag_url))
  Product.create!(category: c1, name: 'Jute Bag', description: 'Stylish Bag at low price. Jute - Jute is a long, soft, shiny vegetable fiber that can be spun into coarse, strong threads. It is produced primarily from plants in the genus Corchorus, which was once classified with the family Tiliaceae, and more recently with Malvaceae. The primary source of the fiber is Corchorus olitorius, but it is considered inferior to Corchorus capsularis.', price: 150, available_quantity: 5, image: URI.encode(jute_bag_url))

  Product.create!(category: c2, name: 'Used Clothes', description: 'Light used clothes. Cloth - Clothing (also called clothes) is fiber and textile material worn on the body. The wearing of clothing is mostly restricted to human beings and is a feature of nearly all human societies. The amount and type of clothing worn depends on physical, social and geographic considerations. Some clothing types can be gender-specific', price: 80, available_quantity: 67, image: URI.encode('https://s3-media1.fl.yelpcdn.com/bphoto/Nx443ww-X5Z6mhslzismZw/ls.jpg'))

  Product.create!(category: c2, name: 'Single Used Clothes', description: 'Light used clothes with zero damage at very low price. Cloth - Clothing (also called clothes) is fiber and textile material worn on the body. The wearing of clothing is mostly restricted to human beings and is a feature of nearly all human societies. The amount and type of clothing worn depends on physical, social and geographic considerations. Some clothing types can be gender-specific', price: 100, available_quantity: 200, image: URI.encode('http://www.gaebler.com/images/startbiz/Used-Clothing-Store.jpg'))
  Product.create!(category: c2, name: 'Hand loomed Rug',
  ...
  Product.create!(category: c3,
                  ...
                  image: URI.encode('hhttps://s-media-cache-ak0.pinimg.com/736x/60/a2/eb/60a2eb51057e2b4a1df6378bbd586f41.jpg'))

  Product.create!(category: c4,
                  name: 'Wooden Chair',
